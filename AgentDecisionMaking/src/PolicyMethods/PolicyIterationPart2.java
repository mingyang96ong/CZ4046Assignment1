...
public class PolicyIterationPart2 {
	...
	public static void main(String[] args) {
		...
		String [][]arr= {{"G", "WALL", "G", "W", "W", "G", "B"},
						 {"W", "B", "W", "G", "W", "B", "G"},
						 {"W", "W", "B", "W", "G", "W", "WALL"},
						 {"W", "W", "W", "B", "W", "G", "W"},
						 {"W", "WALL", "WALL", "WALL", "B", "W", "G"},
						 {"W", "W", "W", "W", "W", "W", "G"},
						 {"G", "G", "W", "B", "G", "WALL", "G"}
		};
		
		// Since this GridWorld has a 7x7 square world, so 6 is pass into the instantiation of GridWorld's row and col
		GridWorld GW = new GridWorld(arr, 7, 7);
		
		// String arr[row][col] represent a NxN square grid for the GridWorld
		// "W" = White Square, "G" = Green Square, "B" = Brown Square, "WALL" = Wall Square, default = White Square
		String [][]arr= {{"G", "WALL", "G", "W", "W", "G", "B", "G"},
						 {"W", "B", "W", "G", "W", "B", "G", "W"},
						 {"W", "W", "B", "W", "G"
						 , "W", "WALL", "G"},
						 {"W", "W", "W", "B", "W", "G", "W", "B"},
						 {"W", "WALL", "WALL", "WALL", "B", "W", "G", "W"},
						 {"W", "W", "W", "W", "W", "W", "G", "WALL"},
						 {"G", "G", "W", "B", "G", "WALL", "G", "G"},
						 {"W", "W", "G", "G", "W", "G", "G", "WALL"}
		};
		
		// Since this GridWorld has a 8x8 square world, so 6 is pass into the instantiation of GridWorld's row and col
		GridWorld GW = new GridWorld(arr, 8, 8);
		
		// String arr[row][col] represent a NxN square grid for the GridWorld
		// "W" = White Square, "G" = Green Square, "B" = Brown Square, "WALL" = Wall Square, default = White Square
		String [][]arr= {{"G", "WALL", "G", "W", "W", "G", "B", "G", "W"},
						 {"W", "B", "W", "G", "W", "B", "G", "W", "B"},
						 {"W", "W", "B", "W", "G", "W", "WALL", "G", "B"},
						 {"W", "W", "W", "B", "W", "G", "W", "B", "W"},
						 {"W", "WALL", "WALL", "WALL", "B", "W", "G", "W", "WALL"},
						 {"W", "W", "W", "W", "W", "W", "G", "WALL", "G"},
						 {"G", "G", "W", "B", "G", "WALL", "G", "G", "G"},
						 {"W", "W", "G", "G", "W", "G", "G", "WALL", "G"},
						 {"G", "B", "B", "B", "W", "W", "G", "WALL", "G"}
		};
				
		// Since this GridWorld has a 9x9 square world, so 6 is pass into the instantiation of GridWorld's row and col
		GridWorld GW = new GridWorld(arr, 9, 9);*/
		
		
		// String arr[row][col] represent a NxN square grid for the GridWorld
		// "W" = White Square, "G" = Green Square, "B" = Brown Square, "WALL" = Wall Square, default = White Square
		String [][]arr= {{"G", "WALL", "G", "W", "W", "G", "B", "G", "W","W", "W", "W", "W", "W", "W", "G", "WALL", "G"},
						 {"W", "B", "W", "G", "W", "B", "G", "W", "B", "G", "WALL", "G", "W", "W", "G", "B", "G", "W"},
						 {"W", "W", "B", "W", "G", "W", "WALL", "G", "B","W", "B", "W", "G", "W", "B", "G", "W", "B"},
						 {"W", "W", "W", "B", "W", "G", "W", "B", "W", "W", "W", "B", "W", "G", "W", "WALL", "G", "B"},
						 {"W", "WALL", "WALL", "WALL", "B", "W", "G", "W", "WALL","W", "W", "W", "B", "W", "G", "W", "B", "W"},
						 {"W", "W", "W", "W", "W", "W", "G", "WALL", "G", "G", "WALL", "G", "W", "W", "G", "B", "G", "W"},
						 {"G", "G", "W", "B", "G", "WALL", "G", "G", "G", "W", "W", "G", "G", "W", "G", "G", "WALL", "G"},
						 {"W", "W", "G", "G", "W", "G", "G", "WALL", "G", "G", "B", "B", "B", "W", "W", "G", "WALL", "G"},
						 {"G", "B", "B", "B", "W", "W", "G", "WALL", "G", "G", "B", "B", "B", "W", "W", "G", "WALL", "G"},
						 {"G", "WALL", "G", "W", "W", "G", "B", "G", "W","W", "W", "W", "W", "W", "W", "G", "WALL", "G"},
						 {"W", "B", "W", "G", "W", "B", "G", "W", "B", "G", "WALL", "G", "W", "W", "G", "B", "G", "W"},
						 {"W", "W", "B", "W", "G", "W", "WALL", "G", "B","W", "B", "W", "G", "W", "B", "G", "W", "B"},
						 {"W", "W", "W", "B", "W", "G", "W", "B", "W", "W", "W", "B", "W", "G", "W", "WALL", "G", "B"},
						 {"W", "WALL", "WALL", "WALL", "B", "W", "G", "W", "WALL","W", "W", "W", "B", "W", "G", "W", "B", "W"},
		...
		// Since this GridWorld has a 18x18 square world, so 6 is pass into the instantiation of GridWorld's row and col
		GridWorld GW = new GridWorld(arr, 18, 18);
